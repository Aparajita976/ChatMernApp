...
export default function Homepage() {
    ...
    useEffect(() => {
        socket.current = io('https://chatbackend-jjk0.onrender.com');
                ...
                <div className="sideStructure">
                    ...
                    <div className='navbar   navbar-light' >
                        ...
                        <div className="collapse navbar-collapse justify-content-end" id="navbarTogglerDemo01">
                            <ul class="navbar-nav">
                                <li class="nav-item nav-item1 nav-link1"><Link to="/userinfo"><img style={{ width: "2.5rem" }} className="topBarImage" src={"https://chatbackend-jjk0.onrender.com/images/images/" + user.user.profilePic} alt="" /></Link></li>
                    ...
                    <div>
                        <div>
                            <input type="text" name="name" class="form-control searchBar" id="name" placeholder='Find a user' onKeyDown={handleKey}
                            ...
                            <div className="navbar chatbar navbar-expand-lg">
                                ...
                                <div >
                                    <img style={{
                                        ...
                                        height: "70px",
                                        borderRadius: "50%"
                                    }} src={friendUser && "https://chatbackend-jjk0.onrender.com/images/images/" + friendUser.user.profilePic} />
                                </div>
                            </div>
